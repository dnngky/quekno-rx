...
This repository provides a `rustworkx` implementation of the benchmark construction algorithm presented in *[On constructing benchmark quantum circuits with near-optimal transformation cost](https://arxiv.org/abs/2301.08932)* by Sanjiang Li, Xiangzhen Zhou, and Yuan Feng. The original implementation may be found [here](https://github.com/ebony72/quekno).
